...
* If you'd like a quick demo of job-collection using this functionality, checkout the a live at [http://jcplayground.meteor.com](http://jcplayground.meteor.com). Source code for the demo app is at [meteor-job-collection-playground](https://github.com/vsivsi/meteor-job-collection-playground) on github.
